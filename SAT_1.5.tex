...
\section{Solving Linear Inequalities (One Variable)}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \fill[white, opacity=0.3] (current page.center) circle (4cm);
        \node[align=center] at (current page.center) {
            {\huge\bfseries\textcolor{purpleblue}{Solving Linear Inequalities (One Variable)}} \\[0.5cm]
            {\large\itshape\textcolor{lightText}{Excellence in SAT Prep}}
        };
        \foreach \x in {1,2,3,4,5} {
            \fill[purpleblue, opacity=0.2] (rand*10-5, rand*7-3.5) circle (0.1+\x*0.05);
...
\section{Linear Inequalities in Two Variables}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \fill[white, opacity=0.3] (current page.center) circle (4cm);
        \node[align=center] at (current page.center) {
            {\huge\bfseries\textcolor{purpleblue}{Linear Inequalities in Two Variables}} \\[0.5cm]
            {\large\itshape\textcolor{lightText}{Excellence in SAT Prep}}
        };
        \foreach \x in {1,2,3,4,5} {
            \fill[purpleblue, opacity=0.2] (rand*10-5, rand*7-3.5) circle (0.1+\x*0.05);
...
\begin{frame}{Linear Inequalities in Two Variables}
    ...
    \begin{enumerate}
        ...
        \item Pick a test point (usually \((0,0)\)) to determine the shading side.
    \end{enumerate}
...
\section{System of Linear Inequalities}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \fill[white, opacity=0.3] (current page.center) circle (4cm);
        \node[align=center] at (current page.center) {
            {\huge\bfseries\textcolor{purpleblue}{System of Linear Inequalities}} \\[0.5cm]
            {\large\itshape\textcolor{lightText}{Excellence in SAT Prep}}
        };
        \foreach \x in {1,2,3,4,5} {
            \fill[purpleblue, opacity=0.2] (rand*10-5, rand*7-3.5) circle (0.1+\x*0.05);
...
\begin{frame}{System of Linear Inequalities}
    ...
    \begin{itemize}
        ...
        \item Step 2: Use dashed or solid lines depending on the symbols \(<\) or \(\le\), or \(>\) or \(\ge\).
...
\begin{frame}{\textbf{Question: System of Inequalities}}
    \small
...
\begin{frame}{\textbf{Answer Explanation: System of Inequalities}}
    \small
    ...
    \begin{itemize}
        ...
        \[
        -14 \leq 0 + 7 = 7 \quad \text{(True)}, \quad -14 \geq -2(0) - 1 = -1 \quad \text{(False)} \quad \Rightarrow \text{Reject}
        \]
        ...
        \[
        0 \leq 14 + 7 = 21 \quad \text{(True)}, \quad 0 \geq -2(14) - 1 = -29 \quad \text{(True)} \quad \Rightarrow \text{Accept}
        \]
    \end{itemize}
...
\begin{frame}{\textbf{Question: Inequality Table Matching}}
    \small
...
\begin{frame}{\textbf{Answer Explanation: Inequality Table Matching}}
    \small
    The inequality is:
    \[
    y < 6x + 2
    ...
    \begin{itemize}
        \item \textbf{A:} \(y = 20, 32, 44\) — not strictly less than the thresholds
        \item \textbf{B:} \(y = 16 < 20\), but \(36 > 32\)
...
\begin{frame}{\textbf{Question: Shipment Inequality Problem}}
    \small
    A laundry service is buying detergent and fabric softener from its supplier. The supplier will deliver no more than 300 pounds in a shipment. Each container of detergent weighs 7.35 pounds, and each container of fabric softener weighs 6.2 pounds. The service wants to buy at least \textbf{twice as many} containers of detergent as containers of fabric softener.

    Let \(d\) represent the number of detergent containers and \(s\) the number of softener containers. Which system of inequalities best represents this situation?
...
\begin{frame}{\textbf{Answer Explanation: Shipment Inequality Problem}}
    \small
    \begin{itemize}
...
\begin{frame}{\textbf{Question: Psychologist Experiment — Inequality Problem}}
    \small
    ...
    \vspace{0.5em}
    \begin{itemize}
        \item[\textbf{A.}] \(p > 0.20(300 - 36)\), where \(p \leq 150\)
        \item[\textbf{B.}] \(p > 0.20(300 + 36)\), where \(p \leq 150\)
        \item[\textbf{C.}] \(p - 36 > 0.20(300)\), where \(p \leq 150\)
        \item[\textbf{D.}] \(p + 36 > 0.20(300)\), where \(p \leq 150\)
    \end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Psychologist Experiment — Inequality Problem}}
    \small
...
\begin{frame}{\textbf{Question: Triangle Inequality Theorem}}
    \small
    ...
    \begin{itemize}
        \item[\textbf{A.}] \(x < 18\)
        \item[\textbf{B.}] \(x \geq 18\)
        \item[\textbf{C.}] \(6 < x < 18\)
        \item[\textbf{D.}] \(x < 6 \text{ or } x > 18\)
    \end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Triangle Inequality Theorem}}
    \small
...
\begin{frame}{\textbf{Question: Graphing Inequality — Point Testing}}
    Given the inequality:
    \[
    y > 7x - 19
    \]
...
\begin{frame}{\textbf{Answer Explanation: Graphing Inequality — Point Testing}}
    \textbf{Step:} Plug each point into the inequality \(y > 7x - 19\).

    \begin{itemize}
        \item[\textbf{A.}] \(-32 > 7(-1) - 19 \Rightarrow -32 > -26\) — False
        \item[\textbf{B.}] \(-20 > 7(0) - 19 \Rightarrow -20 > -19\) — False
        \item[\textbf{C.}] \(-3 > 7(2) - 19 \Rightarrow -3 > -5\) — True
        \item[\textbf{D.}] \(-14 > 7(4) - 19 \Rightarrow -14 > 9\) — False
    \end{itemize}

    \textbf{Correct Answer:} \( \boxed{C} \)
\end{frame}

\begin{frame}{\textbf{Question: System of Inequalities — Graphical Solution}}
...
\begin{frame}{\textbf{Answer Explanation: System of Inequalities — Graphical Solution}}
    Test each point in both inequalities:

    \vspace{0.5em}
    \textbf{A.} \((1, 4)\):
    \[
    y < -4x - 1 \Rightarrow 4 < -4(1) - 1 = -5 \quad \text{False}
    \]

    \textbf{B.} \((-1, 1)\):
    \[
    y < -4x - 1 \Rightarrow 1 < 3 \quad \text{True}, \quad y > x + 2 \Rightarrow 1 > 1 \quad \text{False}
    \]

    \textbf{C.} \((-2, 2)\):
    \[
    y < -4x - 1 \Rightarrow 2 < 7 \quad \text{True}, \quad y > x + 2 \Rightarrow 2 > 0 \quad \text{True}
    \]

    \textbf{D.} \((-3, -3)\):
    \[
    y < -4x - 1 \Rightarrow -3 < 11 \quad \text{True}, \quad y > x + 2 \Rightarrow -3 > -1 \quad \text{False}
    \]

    \textbf{Correct Answer:} \( \boxed{C} \)
\end{frame}

\begin{frame}{\textbf{Question: Inequality — Calories Burned by Jogging}}
...
\begin{frame}{\textbf{Answer Explanation: Inequality — Calories Burned by Jogging}}
...
\begin{frame}{\textbf{Question: Challenging System of Inequalities}}
...
\begin{frame}{\textbf{Answer Explanation: Challenging System of Inequalities}}
    ...
    \[
    2 \leq \frac{1}{2}(0) + 3 \quad \text{True}
    \]
    \[
    2 > -2(0) + 1 \Rightarrow 2 > 1 \quad \text{True}
    \]
