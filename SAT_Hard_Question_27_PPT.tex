...
\title[Test VIII]{\textbf{Test VIII}}
...
\section{Test VIII}
    \begin{tikzpicture}[remember picture, overlay]
        \shade[top color=softPurple, bottom color=softGray]
            (current page.north west) rectangle (current page.south east);
        \node[align=center] at (current page.center) {
            {\LARGE\bfseries\textcolor{purpleblue}{Test VIII}} \\[0.5cm]
            {\Large\itshape\textcolor{lightText}{25 Module 2-style mock exam questions}}
        };
    \end{tikzpicture}
\end{frame}
...
\includegraphics[width=0.45\linewidth]{hard_27_f16.png}
\end{center}
