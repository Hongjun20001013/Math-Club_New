...
\item FR6: $z=2$; about 97.5th percentile; a score of $92$ is more unusual because it is $2$ standard deviations above the mean, while $68$ is only $1$ standard deviation below the mean.
\item FR7: $(x+3)^2+(y-4)^2=25$; $\frac{(x-1)^2}{25}+\frac{(y+2)^2}{9}=1$; $x^2=8(y-1)$.
\item FR8: $c\approx10.1$; area $\approx60.2$ square units; the triangle is not given as right, so Law of Cosines/area with included angle is needed.
