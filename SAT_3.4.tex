...
\textbf{Correct Answer:} \boxed{\text{D. The mass of the particle decreases by 40\% every 3 years.}}
\end{frame}
...
\begin{center}
    \includegraphics[width=0.82\linewidth]{E33.png}
\end{center}
...
\begin{itemize}
    \item The line of best fit appears to pass through approximately \( (12, 480) \) and \( (24, 876) \)
