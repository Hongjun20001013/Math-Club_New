...
\begin{center}
    \includegraphics[width=0.86\linewidth]{unit3_line_graph_snowfall.svg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.86\linewidth]{unit3_boxplots_gazelles.svg}
\end{center}
...
\noindent\markforreview
\begin{center}
    \includegraphics[width=0.86\linewidth]{unit3_dotplots_ab.svg}
\end{center}
...
\noindent\markforreview
\begin{center}
    \includegraphics[width=0.86\linewidth]{unit3_histograms_ab.svg}
\end{center}
...
\noindent\markforreview
\begin{center}
    \includegraphics[width=0.54\linewidth]{unit3_dotplot_a.svg}
\end{center}
