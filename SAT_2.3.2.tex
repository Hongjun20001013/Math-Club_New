...
\title[SAT Unit 2.3.2]{\textbf{SAT Unit 2.3.2 \\Exponential Functions}}
...
\textbf{Options:}
\begin{itemize}
    \item[\textbf{A.}] \(f(x) = 50(2)^{x+1}\)
    \item[\textbf{B.}] \(f(x) = 80(2)^x\)
    \item[\textbf{C.}] \(f(x) = 128(2)^{x-1}\)
    \item[\textbf{D.}] \(f(x) = 205(2)^{x-2}\)
\end{itemize}
\end{frame}
...
\textbf{Options:}
\begin{itemize}
    \item[\textbf{A.}] \(y = 4(x)^{200}\)
    \item[\textbf{B.}] \(y = 4(200)^x\)
    \item[\textbf{C.}] \(y = 200(2)^x\)
    \item[\textbf{D.}] \(y = 200(4)^x\)
\end{itemize}
\end{frame}


\begin{frame}{\textbf{Answer Explanation: Exponential Growth Relationship}}
...
\begin{frame}{\textbf{Answer Explanation: Finding Constant in Exponential Function}}
...
\textbf{Correct Answer:} \( \boxed{-324} \)
\end{frame}
\begin{frame}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{E25.png}
\end{center}
\end{frame}
...
\begin{frame}{\textbf{Answer Explanation: X-Intercepts of an Exponential Function}}
...
\vspace{0.3cm}
\begin{itemize}
    \item[\textbf{A.}] \( r(m) = \dfrac{90,\!000}{12}(1.06)^m \)
    \item[\textbf{B.}] \( r(m) = 90,\!000 \left( \dfrac{1.06}{12} \right)^m \)
    \item[\textbf{C.}] \( r(m) = 90,\!000 \left( \dfrac{1.06}{12} \right)^{\frac{m}{12}} \)
    \item[\textbf{D.}] \( r(m) = 90,\!000(1.06)^{\frac{m}{12}} \)
\end{itemize}
\end{frame}
...
\begin{frame}{\textbf{Question: The function \[ f(t) = 20(1 + 15{100} )^t \] models…}}
The function 
\[
...
\begin{itemize}
  \item[\textbf{A.}] The temperature, in degrees Celsius, of the metal alloy at the beginning of the experiment
  \item[\textbf{B.}] The increase in the temperature, in degrees Celsius, of the metal alloy every 100 seconds during the experiment
  \item[\textbf{C.}] The percent by which the temperature, in degrees Celsius, of the metal alloy decreased from each second to the next during the experiment
  \item[\textbf{D.}] The percent by which the temperature, in degrees Celsius, of the metal alloy increased from each second to the next during the experiment
\end{itemize}
\end{frame}
\begin{frame}{\textbf{Answer Explanation: X-Intercepts of an Exponential Function}}
The function is:
...
\begin{frame}{\textbf{Question: The population of trees in a forest has been…}}
...
\begin{itemize}
  \item[\textbf{A.}] \(P = 14{,}000(0.06)^{\frac{t}{4}}\)
  \item[\textbf{B.}] \(P = 14{,}000 + 0.94(4t)\)
  \item[\textbf{C.}] \(P = 14{,}000(0.94)^{4t}\)
  \item[\textbf{D.}] \(P = 14{,}000(0.94)^{\frac{t}{4}}\)
\end{itemize}
\end{frame}



\begin{frame}{\textbf{Answer Explanation: The population of trees in a forest has been…}}
...
\begin{frame}{\textbf{Question: The amount of data, in gigabytes, stored in a database…}}
...
\begin{itemize}
  \item[\textbf{A.}] \(g(t) = 16(2)^{15t}\)
  \item[\textbf{B.}] \(g(t) = 16(1.02)^{\frac{t}{15}}\)
  \item[\textbf{C.}] \(g(t) = 16(1.02)^{\frac{8t}{5}}\)
  \item[\textbf{D.}] \(g(t) = 16(1.02)^{\frac{5t}{8}}\)
\end{itemize}
\end{frame}


\begin{frame}{\textbf{Answer Explanation: The amount of data, in gigabytes, stored in a database…}}


\textbf{Correct Answer:} \( \boxed{D} \)
\end{frame}

\begin{frame}{\textbf{Question: The exponential function \(g\) is defined by the given…}}
...
\begin{frame}{\textbf{Answer Explanation: The exponential function \(g\) is defined by the given…}}
We are given:
\[
...
\begin{frame}{\textbf{Question: The function \[ W(t) = 830(1.09)^{6{8}t} \] gives the…}}
The function
\[
...
\textbf{Correct Answer:} \( \boxed{n = 16} \)
\end{frame}


\begin{frame}{\textbf{Question: To examine how a certain virus spreads, scientists…}}
...
\begin{itemize}
  \item[\textbf{A.}] The predicted number of infected cells in the test tube doubled every 5 days.
  \item[\textbf{B.}] The predicted number of infected cells in the test tube grew by a factor of 5 every two days.
  \item[\textbf{C.}] The predicted number of infected cells in the test tube doubled every day.
  \item[\textbf{D.}] The predicted number of infected cells in the test tube grew by a factor of 5 every day.
\end{itemize}
\end{frame}


\begin{frame}{\textbf{Answer Explanation: To examine how a certain virus spreads, scientists…}}
The function is:
\[
C(t) = 100(2)^{\frac{t}{5}}
\]
...
\begin{frame}{\textbf{Question: The function \(f\) is defined for all \(x 0\). Which…}}
...
\begin{itemize}
  \item[\textbf{A.}] \(f(x) = 50(2.5)(1.25)^{x - 2}\)
  \item[\textbf{B.}] \(f(x) = 125(0.8)(1.25)^{x - 1}\)
  \item[\textbf{C.}] \(f(x) = 64(1.25)^{x + 1}\)
  \item[\textbf{D.}] \(f(x) = 80(0.64)(1.25)^{x + 2}\)
\end{itemize}
\end{frame}



\begin{frame}{\textbf{Answer Explanation: The function \(f\) is defined for all \(x 0\). Which…}}
