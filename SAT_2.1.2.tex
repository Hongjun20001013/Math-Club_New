...
% 封面信息
\title[SAT Unit 2.1.2]{\textbf{SAT Unit 2.1.2 \\Equivalent Expressions}}
...
\begin{frame}{\textbf{Question: Combining Like Terms}}
    ...
    \textbf{Options:}
    \begin{itemize}
        \item[\textbf{A.}] \(3x^3 + x^2 - 15x - 7\)
        \item[\textbf{B.}] \(3x^3 + 15x^2 - 15x - 7\)
        \item[\textbf{C.}] \(10x^5 - 7x - 7\)
        \item[\textbf{D.}] \(15x^4 + 3x^3 - 15x^2 - 7\)
    \end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Combining Like Terms}}
    Combine like terms:
...
\begin{frame}{Expansion Using FOIL}
    ...
    \textbf{Correct Answer:} \( \boxed{x^2 - 2x - 15} \)
\end{frame}
...
\begin{frame}{\textbf{Answer Explanation: Find the Value of \(ab\)}}
...
\begin{frame}{\textbf{Question: Finding the Value of \( h \)}}
...
\begin{frame}{\textbf{Answer Explanation: Finding the Value of \( h \)}}
    We are given:
\[
(x^3 - hx^2)(5x^2 + 10x)
\]
...
\]
    ...
    \textbf{Correct Answer:} \( \boxed{\dfrac{4}{5}} \)
\end{frame}
...
\begin{frame}{\textbf{Answer Explanation: Factoring a Quadratic Expression}}
...
\begin{frame}{\textbf{Answer Explanation: Finding the Smallest Possible Factor Constant}}
    We are given:
\[
2x^3 + 42x^2 + 208x
\]
...
\]
    ...
    Since the question asks for the smallest possible positive value of \(b\) such that \(x + b\) is a factor, the answer is \(8\).

    \textbf{Correct Answer:} \( \boxed{8} \)
\end{frame}
...
\begin{frame}{\textbf{Answer Explanation: Factoring with Decimal Coefficients}}
    We are given:
\[
...
\]
    ...
    \textbf{Correct Answer:} \( \boxed{0.09} \)
\end{frame}
...
\begin{frame}{\textbf{Answer Explanation: Polynomial Division}}
...
\textbf{Options:}
\begin{itemize}
    \item[\textbf{A.}] \(\frac{1}{x + 1}\)
    \item[\textbf{B.}] \(\frac{x + 3}{x + 1}\)
    \item[\textbf{C.}] \(\frac{x(x - 3)}{x + 1}\)
    \item[\textbf{D.}] \(\frac{x(x + 3)}{x + 1}\)
\end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Simplifying Rational Expressions}}
...
\begin{frame}{\textbf{Question: Adding Rational Expressions}}
    \[
...
\begin{frame}{\textbf{Answer Explanation: Adding Rational Expressions}}
...
\]
    ...
    So:
    \[
    r = 5,\quad t = 4 \Rightarrow rt = 5 \cdot 4 = 20
    \]
...
\section{Isolate a Variable}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[align=center] at (current page.center) {
            {\Huge\bfseries\textcolor{purpleblue}{Isolate a Variable}} \\[0.5cm]
            {\LARGE\itshape\textcolor{lightText}{Excellence in SAT Prep}}
        };
        \foreach \x in {1,2,3,4,5} {
            \fill[purpleblue, opacity=0.2] (rand*10-5, rand*7-3.5) circle (0.1+\x*0.05);
...
\begin{frame}{\textbf{Question: Solving for \(w\) in terms of \(x\) and \(y\)}}
Given the equation:
\[
...
\textbf{Options:}
\begin{itemize}
    \item[\textbf{A.}] \(w = \sqrt{\frac{x}{y}} - 19\)
    \item[\textbf{B.}] \(w = \sqrt{\frac{28x}{14y}} - 19\)
    \item[\textbf{C.}] \(w = \left(\frac{x}{y}\right)^2 - 19\)
    \item[\textbf{D.}] \(w = \left(\frac{28x}{14y}\right)^2 - 19\)
\end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Solving for \(w\) in terms of \(x\) and \(y\)}}
...
\begin{frame}{\textbf{Question: Solving for \(t\) in terms of \(u\)}}
Given the equation:
\[
u - 3 = \frac{6}{t - 2}
\]
...
\textbf{Options:}
\begin{itemize}
    \item[\textbf{A.}] \(t = \frac{1}{u}\)
    \item[\textbf{B.}] \(t = \frac{2u + 9}{u}\)
    \item[\textbf{C.}] \(t = \frac{1}{u - 3}\)
    \item[\textbf{D.}] \(t = \frac{2u}{u - 3}\)
\end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Solving for \(t\) in terms of \(u\)}}
...
\begin{frame}{\textbf{Question: Adding Algebraic Fractions}}
    Which expression is equivalent to
    \[
    ...
    \textbf{Options:}
    \begin{itemize}
        \item[\textbf{A.}] \(\dfrac{2x - 3xy + 4y}{2x^2 - 2xy}\)
        \item[\textbf{B.}] \(\dfrac{2x + 3xy + y}{2x^2 - 2xy}\)
        \item[\textbf{C.}] \(\dfrac{2x + 3xy + y}{2x^3 - 4x^2y + 2xy^2}\)
        \item[\textbf{D.}] \(\dfrac{4y - 3xy + 1}{2x^3 - 4x^2y + 2xy^2}\)
    \end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Adding Algebraic Fractions}}
...
\begin{frame}{\textbf{Question: Solving for \(k\) in terms of \(x\)}}
    If \(\dfrac{4}{k + 2} = \dfrac{x}{3}\), where \(k \ne -2\), which equation correctly expresses \(k\) in terms of \(x\)?

    \textbf{Options:}
    \begin{itemize}
        \item[\textbf{A.}] \(k = \dfrac{12 - 2x}{x}\)
        \item[\textbf{B.}] \(k = \dfrac{12 + 2x}{x}\)
        \item[\textbf{C.}] \(k = \dfrac{x}{12 + 2x}\)
        \item[\textbf{D.}] \(k = 12x - 2\)
    \end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Solving for \(k\) in terms of \(x\)}}
    We are given:
\[
\frac{4}{k + 2} = \frac{x}{3}
\]
...
\begin{frame}{\textbf{Question: Solving for \(G\) in terms of \(L\), \(P\), and \(T\)}}
    \[
    T = 2P \sqrt{\frac{L}{G}}
    \]
    ...
    \textbf{Options:}
    \begin{itemize}
        \item[\textbf{A.}] \(\dfrac{2PL}{T^2}\)
        \item[\textbf{B.}] \(\dfrac{T^2}{4LP^2}\)
        \item[\textbf{C.}] \(\dfrac{LT^2}{4P^2}\)
        \item[\textbf{D.}] \(\dfrac{4LP^2}{T^2}\)
    \end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Solving for \(G\) in terms of \(L\), \(P\), and \(T\)}}
...
\textbf{Options:}
\begin{itemize}
    \item[\textbf{A.}] \(\frac{b}{h}\)
    \item[\textbf{B.}] \(\frac{b}{k}\)
    \item[\textbf{C.}] \(\frac{45}{h}\)
    \item[\textbf{D.}] \(\frac{45}{k}\)
\end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Integer Relationship in Factored Form}}
    We are given:
\[
4x^2 + bx - 45 = (hx + k)(x + j)
\]
