...
\q{27} In the figure shown, points \(A\), \(B\), \(C\), and \(E\) lie on the circle, and \(AB<BC\). Segment \(AC\) is perpendicular to segment \(BE\) at point \(D\), and \(BD=\sqrt{346}\). The diameter of the circle is \(175\). If \(\dfrac{CD}{AD}=r\), what is the value of \(r\)?
