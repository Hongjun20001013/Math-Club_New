...
\qnum{85} The number of red frogs exceeded the number of blue frogs by 80. The number of green frogs was 20 less than the number of blue frogs. If there were 120 blue frogs, what was the sum of the reds, the blues, and the greens?
\work{1.0cm}
...
\qnum{99} Use two unit multipliers to convert 144 square feet to square miles. Write the answer in scientific notation. Round the coefficient to two decimal places.
\work{0.9cm}
