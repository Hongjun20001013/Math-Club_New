    ...
    def test_fresh_student_repair_cycle(self):
        ...
        try:
            with sync_playwright() as pw:
                ...
                self.assertIn("holding-tank log", page.locator("[data-sl-stem]").inner_text())
                visible = page.locator("body").inner_text()
                ...
                _assert_scored_stem(self, page, "cooling vat")
                ...
                _assert_scored_stem(self, page, "salt brine")
                ...
                page.fill("input[data-faded-blank=removed_amount]", "720")
                page.fill("input[data-faded-blank=start_amount]", "2880")
                page.locator("#sr-form button[type=submit]").click()
                page.wait_for_load_state("networkidle")
                ...
                _assert_scored_stem(self, page, "surveyor remaining-mass")
                ...
                _assert_scored_stem(self, page, "remaining-quantity graph")
