...
\title[SAT Unit 2.3.1]{\textbf{SAT Unit 2.3.1 \\Rational and Polynomial Functions}}
...
\begin{frame}{\textbf{Answer Explanation: Solving a Factored Equation with Radicals}}
We are given:
\[
...
\Rightarrow 5k = 32 \Rightarrow k = 6.4
\]
...
\begin{itemize}
    \item[\textbf{A.}] \( h(x) = f(x) + g(x) \)
    \item[\textbf{B.}] \( p(x) = f(x) + 3g(x) \)
    \item[\textbf{C.}] \( r(x) = 2f(x) + 3g(x) \)
    \item[\textbf{D.}] \( s(x) = 3f(x) + 2g(x) \)
\end{itemize}
\end{frame}


\begin{frame}{\textbf{Answer Explanation: Polynomial Divisibility}}
...
\begin{itemize}
    \item[\textbf{A.}] \( x - 5 \) is a factor of \( p(x) \).
    \item[\textbf{B.}] \( x - 2 \) is a factor of \( p(x) \).
    \item[\textbf{C.}] \( x + 2 \) is a factor of \( p(x) \).
    \item[\textbf{D.}] The remainder when \( p(x) \) is divided by \( x - 3 \) is \(-2\).
\end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: Remainder Theorem and Polynomial Evaluation}}
...
\begin{frame}{\textbf{Answer Explanation: Behavior of Rational Function}}
...
\begin{itemize}
\item[\textbf{A.}] \(f(x) = (x + 3)^2(x - 2)\)
\item[\textbf{B.}] \(f(x) = (x + 3)(x - 2)^2\)
\item[\textbf{C.}] \(f(x) = (x - 3)^2(x + 2)\)
\item[\textbf{D.}] \(f(x) = (x - 3)(x + 2)^2\)
\end{itemize}
\end{frame}
...
\begin{itemize}
\item[\textbf{A.}] \(x - 4\) is a factor of \(q(x)\).
\item[\textbf{B.}] \(x + 4\) is a factor of \(q(x)\).
\item[\textbf{C.}] The remainder when \(q(x)\) is divided by \(x - 4\) is \(7\).
\item[\textbf{D.}] The remainder when \(q(x)\) is divided by \(x + 4\) is \(7\).
\end{itemize}
\end{frame}
