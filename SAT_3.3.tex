...
\title[SAT Unit 3.3]{\textbf{SAT Unit 3.3 \\One-Variable Data}}
...
\begin{frame}{\textbf{Question: Data Set and Mean Problem}}
...
\begin{frame}{\textbf{Answer Explanation: Data Set and Mean Problem}}
...
\begin{frame}{\textbf{Question: Effect of Adding an Outlier to a Data Set}}
...
\begin{itemize}
    \item[\textbf{I.}] The mean
    \item[\textbf{II.}] The median
\end{itemize}
...
\begin{frame}{\textbf{Answer Explanation: Effect of Adding an Outlier to a Data Set}}
\begin{itemize}
...
\begin{itemize}
    \item[\textbf{A.}] Median
    \item[\textbf{B.}] Mean
    \item[\textbf{C.}] Sum of the numbers
    \item[\textbf{D.}] Standard deviation
\end{itemize}
\end{frame}
...
The only measure that does \textbf{not} stay the same is the standard deviation.
...
\begin{itemize}
    \item[\textbf{A.}] The mean mass of group 1 is greater than the mean mass of group 2.
    \item[\textbf{B.}]The mean mass of group 1 is less than the mean mass of group 2.
    \item[\textbf{C.}] The median mass of group 1 is greater than the median mass of group 2.
    \item[\textbf{D.}] The median mass of group 1 is less than the median mass of group 2.
\end{itemize}
...
\begin{itemize}
        \item[\textbf{A.}] The median of data set B is equal to the median of data set A, and the range of data set B is equal to the range of data set A.
        \item[\textbf{B.}] The median of data set B is equal to the median of data set A, and the range of data set B is greater than the range of data set A.
        \item[\textbf{C.}] The median of data set B is greater than the median of data set A, and the range of data set B is equal to the range of data set A.
        \item[\textbf{D.}] The median of data set B is greater than the median of data set A, and the range of data set B is greater than the range of data set A.
\end{itemize}
\end{frame}
...
\begin{frame}{\textbf{Question: Median Comparison – Grouped Data}}
...
\begin{frame}{\textbf{Answer Explanation: Median Comparison – Grouped Data}}
To find the medians:
...
\begin{frame}{\textbf{Question: Median Comparison of Data Sets P and Q}}
...
\begin{frame}{\textbf{Answer Explanation: Median Comparison of Data Sets P and Q}}
...
\textbf{Correct Answer:} \( \boxed{9} \)
\end{frame}

\begin{frame}{\textbf{Question: The frequency table summarizes the prices of 30 items…}}
...
\begin{itemize}
 \item[\textbf{A.}] The mean and median will both decrease.
 \item[\textbf{B.}] The mean and median will both increase.
 \item[\textbf{C.}] The mean will decrease, and the median will remain the same.
 \item[\textbf{D.}] The mean will increase, and the median will remain the same.
\end{itemize}
\end{frame}


\begin{frame}{\textbf{Answer Explanation: The frequency table summarizes the prices of 30 items…}}
...
\begin{itemize}
 \item[\textbf{A.}] The standard deviation of travel times for bus A is less than the standard deviation of travel times for bus B.
 \item[\textbf{B.}] The standard deviation of travel times for bus B is less than the standard deviation of travel times for bus A.
 \item[\textbf{C.}] The standard deviation of travel times for bus A is equal to the standard deviation of travel times for bus B.
 \item[\textbf{D.}] There is not enough information to compare these standard deviations.
\end{itemize}
\end{frame}

\begin{frame}{\textbf{Answer Explanation: The tables give the distribution of daily travel times…}}
...
\begin{frame}{\textbf{Question: Comparing Frequency Tables for Data Set A}}
\textbf{Data set A}
\begin{center}
\begin{tabular}{|c|c|}
\hline
...
\begin{frame}{\textbf{Answer Explanation: Comparing Frequency Tables for Data Set A}}
...
\begin{frame}{\textbf{Question: Comparing Data Sets A and B}}
...
\begin{itemize}
 \item[\textbf{A.}] The mean of data set B is equal to the mean of data set A, and the standard deviation of data set B is equal to the standard deviation of data set A.
 \item[\textbf{B.}] The mean of data set B is equal to the mean of data set A, and the standard deviation of data set B is greater than the standard deviation of data set A.
 \item[\textbf{C.}] The mean of data set B is greater than the mean of data set A, and the standard deviation of data set B is equal to the standard deviation of data set A.
 \item[\textbf{D.}] The mean of data set B is greater than the mean of data set A, and the standard deviation of data set B is greater than the standard deviation of data set A.
\end{itemize}
\end{frame}
...
\begin{frame}{\textbf{Answer Explanation: Comparing Data Sets A and B}}
